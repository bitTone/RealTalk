...
public class LoginactivityFragment extends Fragment {
    ...
    public static class LoginFragment extends Fragment implements LoginContract.View {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            contentContainer = v.findViewById(R.id.cont_login_fragment);

            emailInput = (EditText) v.findViewById(R.id.edt_login_email);
            passwordInput = (EditText) v.findViewById(R.id.edt_login_password);

            emailLabel = (TextView) v.findViewById(R.id.txt_login_email_sub);
            passwordLabel = (TextView) v.findViewById(R.id.txt_login_password_sub);
